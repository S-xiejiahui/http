...
files := js/app.js
update:
	@sed -i 's/$(JS_FILE_IP_ADDR)/$(LOACL_IP_ADDR)/' $(files)
	@echo "replace [\033[33m$(files)'s\033[0m] old_IP(\033[36m$(JS_FILE_IP_ADDR)\033[0m) as local_IP(\033[31m$(LOACL_IP_ADDR)\033[0m)"
	@chmod 777 ./ -R
